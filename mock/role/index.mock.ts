...
const adminList = [
  {
    ...
    children: [
      ...
      {
        path: 'detect',
        component: 'views/Dashboard/Detect',
        name: 'detect',
        meta: {
          title: 'router.detect',
          noCache: true,
      ...
      // {
      //   path: 'config',
      //   component: 'views/Dashboard/Config',
      //   name: 'config',
      //   meta: {
      //     title: 'router.config',
      //     noCache: true,
  ...
  [
    {
      ...
      children: [
        ...
        {
          path: 'detect',
          component: 'views/Dashboard/Detect.vue',
          name: 'detect',
          meta: {
            title: '检测数据',
            noCache: true
        ...
        {
          path: 'config',
          component: 'views/Dashboard/Config.vue',
          name: 'config',
          meta: {
            title: '配置',
            noCache: true
