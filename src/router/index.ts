...
export const constantRouterMap: AppRouteRecordRaw[] = [
  {
    path: '/',
    component: Layout,
    redirect: '/redirect/analysis/index',
    name: 'Root',
    meta: {
      hidden: true
    }
...
export const asyncRouterMap: AppRouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'detect',
        component: () => import('@/views/Dashboard/Detect.vue'),
        name: 'Detect',
        meta: {
          title: t('router.detect'),
          noCache: true
